...
function Sidebar() {
  ...
  return (
    <div className="h-screen hidden sm:block sm:min-w-[255px] border-r-[1px] border-gray-200 flex flex-col">
      ...
      <div className="self-flex-end mb-0 mt-auto border-2 float-bottom">
